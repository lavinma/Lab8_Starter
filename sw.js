  ...
  event.waitUntil(
    caches.open(CACHE_NAME).then(function (cache) {
      ...
      return cache.addAll([
        ...
        './recipes/https://adarsh249.github.io/Lab8-Starter/recipes/1_50-thanksgiving-side-dishes.json',
        './recipes/https://adarsh249.github.io/Lab8-Starter/recipes/2_roasting-turkey-breast-with-stuffing.json',
        './recipes/https://adarsh249.github.io/Lab8-Starter/recipes/3_moms-cornbread-stuffing.json',
        './recipes/https://adarsh249.github.io/Lab8-Starter/recipes/4_50-indulgent-thanksgiving-side-dishes-for-any-holiday-gathering.json',
        './recipes/https://adarsh249.github.io/Lab8-Starter/recipes/5_healthy-thanksgiving-recipe-crockpot-turkey-breast.json',
        './recipes/https://adarsh249.github.io/Lab8-Starter/recipes/6_one-pot-thanksgiving-dinner.json'
      ]);
    })
  );
});
